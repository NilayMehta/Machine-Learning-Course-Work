...
plt.figure()
title = 'Handwriting Verification Boosted Decision Trees(AdaBoost): Performance x Num Estimators'
plt.title('\n'.join(wrap(title,60)))
...
plt.savefig('plots/HandwritingVerification/Boosting/HandwritingVerification_ADABoost_PerformancexNumEstimators.png')
print 'plot complete'
...
print 'plotting results'
plt.figure()
title = 'Handwriting Verification Boosted Decision Trees(GradientBoostingClassifier): Performance x Num Estimators'
plt.title('\n'.join(wrap(title,60)))
plt.plot(max_n_estimators, test_err4, '-', label='test error, max_depth = 4')
plt.plot(max_n_estimators, train_err4, '-', label='train error, max_depth = 4')
plt.plot(max_n_estimators, test_err6, '-', label='test error, max_depth = 6')
...
plt.xlabel('Num Estimators')
plt.ylabel('Mean Square Error')
plt.savefig('plots/HandwritingVerification/Boosting/HandwritingVerification_GradientBoostingClassifier_PerformancexNumEstimators.png')
print 'plot complete'
### ---